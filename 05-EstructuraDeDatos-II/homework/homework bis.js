...
Implementar la clase LinkedList, definiendo los siguientes métodos:
  ...
  cuyo valor coincida con lo buscado; en el segundo, buscamos un nodo cuyo valor, 
...
Nuetra tabla hash, internamente, consta de un arreglo de buckets (slots, contenedores, o casilleros; 
  es decir, posiciones posibles para almacenar la información), donde guardaremos datos en 
  formato clave-valor (por ejemplo, {instructora: 'Ani'}).
...
HashTable.prototype.set = function(key, value){
  if(typeof value !== string){
    throw new TypeError("No es un string");
  }
